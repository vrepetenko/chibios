...
/* Using shorter definitions in order to make code uniform across devices
   exposing pre-FIFO and FIFO-capable USART register names.*/
#if !defined(USART_CR1_TXEIE_Pos)
#define USART_CR1_TXEIE_Pos                 USART_CR1_TXEIE_TXFNFIE_Pos
#endif
#if !defined(USART_CR1_TXEIE_Msk)
#define USART_CR1_TXEIE_Msk                 USART_CR1_TXEIE_TXFNFIE_Msk
#endif
#if !defined(USART_CR1_TXEIE)
#define USART_CR1_TXEIE                     USART_CR1_TXEIE_Msk
#endif

#if !defined(USART_CR1_RXNEIE_Pos)
#define USART_CR1_RXNEIE_Pos                USART_CR1_RXNEIE_RXFNEIE_Pos
#endif
#if !defined(USART_CR1_RXNEIE_Msk)
#define USART_CR1_RXNEIE_Msk                USART_CR1_RXNEIE_RXFNEIE_Msk
#endif
