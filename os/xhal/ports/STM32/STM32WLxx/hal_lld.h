 ...
 */
#if !defined(STM32WLxx_XMCUCONF)
#error "Using a wrong xxmcuconf.h file, STM32WLxx_XMCUCONF not defined"
#endif
...
#error "STM32_TARGET_CORE not defined in xmcuconf.h"
#endif
...
#error "wrong target core specified in xxmcuconf.h"
#endif
...
#define STM32_VOS1_PLLVCO_MIN       95950000U
...
#define STM32_VOS2_PLLVCO_MIN       95950000U
...
#error "STM32_HSE32SRC should be defined in xmcuconf.h"
#endif

#if STM32_HSE32SRC != STM32_HSE32_XTAL &&                                   \
    STM32_HSE32SRC != STM32_HSE32_TCXO &&                                   \
    STM32_HSE32SRC != STM32_HSE32_EXTS
#error "STM32_HSE32SRC should be defined in xmcuconf.h with correct value"
#endif
...
#error "STM32_C2HPRE not defined in xmcuconf.h"
#endif
#else /* (STM32_HAS_M0 == FALSE) */
#if defined(STM32_C2HPRE)
#error "STM32_C2HPRE should not be defined in xmcuconf.h"
#else
