...
PLATFORMSRC := $(CHIBIOS)/os/xhal/ports/common/ARMCMx/nvic.c \
               $(CHIBIOS)/os/xhal/ports/STM32/STM32WLxx/stm32_isr.c \
               $(CHIBIOS)/os/xhal/ports/STM32/STM32WLxx/hal_lld.c

# Required include directories.
PLATFORMINC := $(CHIBIOS)/os/xhal/ports/common/ARMCMx \
               $(CHIBIOS)/os/xhal/ports/STM32/STM32WLxx
...
HALCONF := $(strip $(shell cat $(HALCONFDIR)/xhalconf.h | egrep -e "\#define"))

else
endif

# Drivers compatible with the platform.
include $(CHIBIOS)/os/xhal/ports/STM32/LLD/ADCv5/driver.mk
...
include $(CHIBIOS)/os/xhal/ports/STM32/LLD/SYSTICKv2/driver.mk
include $(CHIBIOS)/os/xhal/ports/STM32/LLD/TIMv1/driver.mk
include $(CHIBIOS)/os/xhal/ports/STM32/LLD/USARTv2/driver.mk
